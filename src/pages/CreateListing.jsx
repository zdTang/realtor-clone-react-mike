...
function CreateListing() {
  console.log("in the CreateListing");
  const [geolocationEnabled, setGeolocationEnabled] = useState(true); //to initialize the state of geolocationEnabled(if we have GOOGLE api)
  const auth = getAuth();
  ...
  async function handleSubmit(e) {
    ...
    } // if not enabled, just use Longitude and Latitude to show the Location(these need manually input)
    else {
